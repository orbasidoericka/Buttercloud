...
try {
    ...
    $pdo->exec("ALTER TABLE products MODIFY id bigint UNSIGNED NOT NULL AUTO_INCREMENT");
    
    // Add primary key if not exists
    $pdo->exec("ALTER TABLE products ADD PRIMARY KEY (id)");
    
    echo "Products table fixed!\n";
...
try {
    ...
    echo "\n✅ Successfully seeded " . count($products) . " products to Railway!\n";
